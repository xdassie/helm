...
USER root
RUN cp linux-amd64/tiller /usr/bin/tiller && chgrp root /usr/bin/tiller && chmod 750 /usr/bin/tiller && cp linux-amd64/helm /usr/bin/helm && chgrp root /usr/bin/helm && chm
od 750 /usr/bin/helm
